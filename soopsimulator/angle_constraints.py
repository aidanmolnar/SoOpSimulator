...
class AngleConstraintCalculator:
    ...
    def __init__(
        ...
        max_incidence_angle: np.ndarray,
        ...
        # R is array of receiver    positions with shape (time, num receivers,    1, 3)
        # T is array of transmitter positions with shape (time, 1, num transmitters, 3)
        # S is array of receiver    positions with shape (time, num rece, num trans, 3)
